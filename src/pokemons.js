...
]; // Replace this with your actual Pokemon data array

// Iteration 1: All Fire Pokemons
const firePokemons = pokemons.filter(pokemon => pokemon.type.includes("Fire"));

// Iteration 2: Shortest Pokemon
const shortestPokemon = pokemons.reduce((shortest, current) => 
  parseFloat(current.height) < parseFloat(shortest.height) ? current : shortest
);

// Iteration 3: candy_count average
const candyCountAverage = pokemons.reduce((sum, pokemon) => sum + (pokemon.candy_count || 0), 0) / pokemons.length;

// Iteration 4: images for the first 10 Ground Pokemons
const groundPokemonsImages = pokemons
...
const heavierPokemons = pokemons.filter(pokemon => parseFloat(pokemon.weight) > parseFloat(pikachuWeight)).map(pokemon => pokemon.name);

// Iteration 6: Alphabetic Order
const alphabeticOrderNames = pokemons
...
// Final Answers
console.log("Fire Pokemons:", firePokemons);
console.log("Shortest Pokemon:", shortestPokemon.name);
console.log("Candy Count Average:", candyCountAverage);
console.log("Images for the first 10 Ground Pokemons:", groundPokemonsImages);
console.log("Pokemon Names Heavier than Pikachu:", heavierPokemons);
console.log("Alphabetic Order - First 20 Names:", alphabeticOrderNames);
console.log("Strong Pokemons:", strongPokemons);
